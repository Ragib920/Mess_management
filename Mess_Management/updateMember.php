      ...
      $(".image-preview-input input:file").change(function (){
          ...
          reader.readAsDataURL(file);
               ...
               <div class="input-group image-preview">
                   ...
                   <input type="text"  value="<?php echo $file_name; ?>"  class="form-control image-preview-filename" > <!-- don't give a name === doesn't send on POST/GET -->
                   <span class="input-group-btn">
             ...
             <div class="row">
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="text"  name="phone" class="form-control" value="<?php echo $phone ;?>" placeholder="phone"  required >
                   </div>
              </div>
             </div>
             <div class="row">
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="gmail" name="gmail" value="<?php echo $gmail ;?>" class="form-control" placeholder="abc@gmail.com"  required >
                   </div>
              </div>
             </div>
             <div class="row">
