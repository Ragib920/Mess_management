        ...
        <div class="col-md-12">
          ...
          <?php
              ...
              if(isset($_POST['search'])){
                $name=$_POST['name'];
                $sql = "SELECT * FROM member_info where name LIKE '%$name%' OR phone LIKE '%$name%' order by ID ASC";
               //echo "search by name";
              }else{
         ...
         <div class="row">
           ...
           <div class="col-md-4">
             <!--  <p>Meal list of the Month</p> -->
           </div>
           <div class="col-md-4">
             <b>Meal list of the Month</b>
