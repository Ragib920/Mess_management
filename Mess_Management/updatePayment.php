 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-edit"></i> Updates</li>
        <li class="active">  </li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  <section class="content">
    ...
    <div class="row">
    <!-- hole body -->
    <div class="col-md-9" style="margin-left: 50px;text-align: center;">
      <form class="" action="insertPayment.php" method="post">
        <div class="form-group"  >
            <div class="col-md-3" style="margin-left:50px;">
              <label for="num">Amount:</label>
              <input type="number" class="form-control" placeholder="BDT" id="paymentAmount" name="paymentAmount" required >
            </div>
        </div>
        <div class="form-group" >
            <div class="col-md-3" style="margin-left:30px;">
              <label for="num">Payment By :</label>
              <input type="text" class="form-control" placeholder="Name"id="paymentName" name="paymentName" required >
            </div>
        </div>
        <div class="form-group">
          <div class="col-md-3" style="margin-right: 10px;margin-top:25px;">
  ...
  <div class="row">
    <div class="col-md-11">
      <table class="table" style="margin-left:55px;">
         <thead>
           <tr class="info">
             <th>Date</th>
             <th>Name</th>
         ...
         <tbody>
           <?php
               ...
               $sql = "SELECT * FROM  payment_information order by payment_id desc LIMIT 5";
