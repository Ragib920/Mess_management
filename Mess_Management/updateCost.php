  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-9" style="margin-left: 50px;text-align: center;">
        <form class="" action="insertCost.php" method="post">
          <div class="form-group"  >
              <div class="col-md-3" style="margin-left:50px;">
                <label for="num">Cost Amount:</label>
                <input type="number" class="form-control" placeholder="BDT" id="costAmount" name="costAmount" required >
              </div>
          </div>
          <div class="form-group" >
              <div class="col-md-3" style="margin-left:30px;">
                <label for="num">Cost By:</label>
                <input type="text" class="form-control" placeholder="Name"id="costBy" name="costName" required >
              </div>
          </div>
          <div class="form-group">
        ...
        <table class="table" style="margin-left:55px;">
           ...
           <tbody>
             <?php
                 ...
                 $sql = "SELECT * FROM  cost_information order by cost_ID desc LIMIT 5";
